...
namespace GigHub.Tests.Persistence
{
    ...
    public class GigRepositoryTests
    {
        ...
        [TestMethod]
        public void GetUpComingGigsByArtist_GigIsInThePast_SouldNotBeReturned()
        {
        ...
        [TestMethod]
        public void GetUpcomingGigsByArtist_GigForADifferentArtist_SholdNotBeReturned()
        {
            var gig = new Gig() { DateTime = DateTime.Now.AddDays(1), ArtistId = "1" };
        ...
        [TestMethod]
        public void GetUpcomingGigsByArtist_GigIsTheGivenArtistAndInTheFuture_SholdBeReturned()
        {
            var gig = new Gig() { DateTime = DateTime.Now.AddDays(1), ArtistId = "1" };
        ...
        public void GetGigsUserAttending_AttendeeIsDifferent_ShouldNotBeReturned()
        {
            var gig = new Gig() { DateTime = DateTime.Now.AddDays(1) };
            var attendance = new Attendance() { Gig = gig, AttendeeId = "1" };
            _mockAttendance.SetSource(new[] { attendance });
